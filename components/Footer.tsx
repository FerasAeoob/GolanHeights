        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8 mb-12">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 pt-2">
              <a href="#" aria-label="Facebook" className="p-2 rounded-full bg-zinc-900 hover:bg-emerald-500 hover:text-white transition-colors duration-300">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="#" aria-label="Instagram" className="p-2 rounded-full bg-zinc-900 hover:bg-emerald-500 hover:text-white transition-colors duration-300">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="#" aria-label="Twitter" className="p-2 rounded-full bg-zinc-900 hover:bg-emerald-500 hover:text-white transition-colors duration-300">
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-zinc-300 hover:text-emerald-400 transition-colors duration-200 flex items-center gap-2 group"
                  >
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-zinc-300">{dict.address1}<br />{dict.address2}</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-5 h-5 text-emerald-500 shrink-0" />
                <span className="text-zinc-300" dir="ltr">+972 50 123 4567</span>
              </li>
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-emerald-500 shrink-0" />
                <span className="text-zinc-300">info@golanheights.com</span>
              </li>
            </ul>
          </div>
