            ...
            <div className="flex justify-between items-center w-full lg:max-w-[1400px] max-w-[1200px] px-4  ">
                <div>
                    <Link href={`/${lang}`} className="flex items-center font-bold gap-3">
                        ...
                        <h1 className="text-2xl font-bold bg-[radial-gradient(circle,_#f2dbb6_40%,_#e8bf82_60%,_#d4a968_100%)] bg-clip-text text-transparent hidden md:block">Golan WIKI</h1>
                    </Link>
                </div>
