                            ...
                            {chapters.map((chapter, index) => {
                                ...
                                return (
                                    <article
                                        ...
                                        data-index={index}
                                        className={`relative w-full min-w-0 overflow-hidden rounded-3xl border p-6 shadow-xl transition-all duration-500 motion-reduce:transition-none sm:p-8 xl:min-h-[470px] xl:rounded-[2rem] xl:p-9 ${isActive
                                    ...
                                    >
                                        ...
                                        <div className="flex min-w-0 flex-col gap-5">
                                            <div>
                                                ...
                                                <h3
                                                    className={`mt-5 text-2xl font-extrabold tracking-normal text-white sm:text-3xl md:text-4xl ${isArabic ? "leading-[1.35]" : "leading-tight"
                                                        }`}
                                                >
                                                    {chapter.title}
                                                </h3>
                                                <p
                                                    className={`text-sm font-semibold text-zinc-400 ${isArabic ? "mt-4 leading-7" : "mt-3"
                                                        }`}
                                                >
                                                    {chapter.period}
                                                </p>
