...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `${SITE_URL}${getLocalizedPathname("/terms-of-use", lang, "", "")}`,
      languages: {
        en: `${SITE_URL}${getLocalizedPathname("/terms-of-use", "en", "", "")}`,
        ar: `${SITE_URL}${getLocalizedPathname("/terms-of-use", "ar", "", "")}`,
        he: `${SITE_URL}${getLocalizedPathname("/terms-of-use", "he", "", "")}`,
        "x-default": `${SITE_URL}${getLocalizedPathname("/terms-of-use", "en", "", "")}`,
      },
    },
  };
}
