...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `${SITE_URL}${getLocalizedPathname("/privacy-policy", lang, "", "")}`,
      languages: {
        en: `${SITE_URL}${getLocalizedPathname("/privacy-policy", "en", "", "")}`,
        ar: `${SITE_URL}${getLocalizedPathname("/privacy-policy", "ar", "", "")}`,
        he: `${SITE_URL}${getLocalizedPathname("/privacy-policy", "he", "", "")}`,
        "x-default": `${SITE_URL}${getLocalizedPathname("/privacy-policy", "en", "", "")}`,
      },
    },
  };
}
